...
//var games: [Game] = [Game(title: "The Last Of Us 2", rate: "4/5", description: "The Last of Us Part II is the sequel to the post-apocalyptic zombie game The Last of Us. The game follows Ellie, the girl who was the secondary protagonist and the player character's companion in The Last of Us. The game is set five years after the ending of the original. Both Ellie (who is by 19 now) and Joel survived and live in Jackson, Wyoming, where Ellie is dating another girl, Dina. However, the characters have to deal with the evil cult called the Seraphites, who try to sacrifice their former members. A matter of revenge forces Ellie and her friends to undertake a trip to Seattle, Washington, to kill their enemies. The major theme of the plot is Ellie's dealing with her hate issues.", photo: UIImage(named: "thelastofus")!), Game(title: "Cyberpunk 2077", rate: "4/5", description: "Cyberpunk 2077 is a science fiction game loosely based on the role-playing game Cyberpunk 2020. Setting The game is set in the year 2077 in a fictional futuristic metropolis Night City in California. In the world of the game, there are developed cybernetic augmentations that enhance people's strength, agility, and memory.", photo: UIImage(named: "cyberpunk")!)]
